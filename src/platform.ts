  ...
  async fetchDevices() {
    ...
    try {
      ...
      if (response.headers.get('content-type')?.includes('application/json')) {
        ...
        throw new Error('API response from AWN is not JSON. This happens ocasionally due to the fragility of the AWN API and is usually resolved by retrying the request in a few minutes.');
      }
